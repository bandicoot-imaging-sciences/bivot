    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs>
        <ButtonGroup variant="contained" color="primary" aria-label="contained primary button group">
          <Tooltip title="90 anti-clockwise"><Button onClick={() => {onChange(90)}}><RotateLeft /></Button></Tooltip>
          <Tooltip title="90 clockwise"><Button onClick={() => {onChange(-90)}}><RotateRight /></Button></Tooltip>
          <Tooltip title="Nudge anti-clockwise"><Button onClick={() => {onChange(0.5)}}><ArrowLeft /></Button></Tooltip>
          <Tooltip title="Nudge anti-clockwise"><Button onClick={() => {onChange(-0.5)}}><ArrowRight /></Button></Tooltip>
        </ButtonGroup>
      </Grid>
    </Grid>
  );
